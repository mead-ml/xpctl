...
def get_results_by_prop(dataset, eid=None, sha1=None, label=None, reduction_dim=None, metric=None, sort=None, numexp_reduction_dim=None, event_type=None):  # noqa: E501
...
def list_experiments_by_prop(eid=None, sha1=None, dataset=None, label=None, user=None, metric=None, sort=None, event_type=None):  # noqa: E501
